...
#    Updated: 2025/01/15 11:21:28 by mfortuna         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
CC				= cc
CFLAGS 			= -Wall -Werror -Wextra -g -I/usr/local/opt/readline/include -I/usr/include -I/usr/local/include
...
PARSER			= $(addprefix $(SRC_M)parser/, parser.c parser_utils.c 1st_step.c built_cmds.c full_input.c init.c cmds_utils.c strdup_noq.c)
STRUCT			= $(addprefix $(SRC_M)struct/, struct_cmds.c struct_env.c delete_env.c find_env.c struct_files.c)
UTILS			= $(addprefix $(SRC_M)utils/, utils.c ft_fprintf.c utils2.c built_utils.c signals.c)
